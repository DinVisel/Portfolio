...
export default function HeroTile() {
  return (
    <HeroParallax className="md:col-span-8 md:row-span-2 glass-card rounded-xl p-8 relative overflow-hidden flex flex-col justify-between group">
      <div
        ...
        style={{
          ...
          transform:
            "translate(calc(var(--parallax-x, 0px) * -0.5), calc(var(--parallax-y, 0px) * -0.5))",
        }}
      ></div>
      {/* Background Code Snippet */}
      <div
        className="absolute top-0 right-0 p-6 opacity-5 font-label-sm text-label-sm select-none pointer-events-none group-hover:opacity-10 transition-opacity"
        style={{
      ...
      <div className="relative z-10">
        ...
        <h1 className="font-headline-xl text-headline-xl mb-4 max-w-2xl text-on-surface">
          ...
          <Typewriter
            text={profile.headline.highlight}
